...
(function () {
	...
	angular.module('rpError').controller('rpErrorCtrl', ['$scope', '$rootScope', '$routeParams', 'rpAppTitleChangeService', rpErrorCtrl]);

	function rpErrorCtrl($scope, $rootScope, $routeParams, rpAppTitleChangeService) {

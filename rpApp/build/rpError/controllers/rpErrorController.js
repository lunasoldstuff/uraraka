...
(function () {
  ...
  angular.module('rpError').controller('rpErrorCtrl', ['$scope', '$rootScope', '$routeParams', 'rpAppTitleChangeService', 'rpToolbarButtonVisibilityService', rpErrorCtrl]);

  function rpErrorCtrl($scope, $rootScope, $routeParams, rpAppTitleChangeService, rpToolbarButtonVisibilityService) {

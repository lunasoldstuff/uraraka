...
(function () {
  ...
  angular.module('rpSubmit').controller('rpSubmitFormCtrl', ['$scope', '$rootScope', '$interval', '$timeout', '$mdDialog', '$window', 'rpSubmitService', 'rpSubredditsService', 'rpAppLocationService', 'rpToolbarButtonVisibilityService', rpSubmitFormCtrl]);

  function rpSubmitFormCtrl($scope, $rootScope, $interval, $timeout, $mdDialog, $window, rpSubmitService, rpSubredditsService, rpAppLocationService, rpToolbarButtonVisibilityService) {
    ...
    $scope.submitLink = function (e) {
      ...
      */
      ...
      rpSubmitService(kind, $scope.resubmit, $scope.sendreplies, $scope.subreddit, $scope.text, $scope.title, $scope.url, $scope.iden, $scope.captcha, function (err, data) {
        if ($scope.isFeedback) {
          $scope.subreddit = 'reddupco';
        }

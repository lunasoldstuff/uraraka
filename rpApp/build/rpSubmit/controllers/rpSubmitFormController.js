...
(function () {
	...
	angular.module('rpSubmit').controller('rpSubmitFormCtrl', ['$scope', '$rootScope', '$interval', '$timeout', '$mdDialog', '$window', 'rpSubmitService', 'rpSubredditsService', 'rpAppLocationService', rpSubmitFormCtrl]);

	function rpSubmitFormCtrl($scope, $rootScope, $interval, $timeout, $mdDialog, $window, rpSubmitService, rpSubredditsService, rpAppLocationService) {

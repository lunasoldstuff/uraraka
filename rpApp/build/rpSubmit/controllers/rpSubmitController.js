...
(function () {
  ...
  angular.module('rpSubmit').controller('rpSubmitCtrl', ['$scope', '$rootScope', '$routeParams', 'rpAppTitleChangeService', 'rpToolbarButtonVisibilityService', rpSubmitCtrl]);

  function rpSubmitCtrl($scope, $rootScope, $routeParams, rpAppTitleChangeService, rpToolbarButtonVisibilityService) {

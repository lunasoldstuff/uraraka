...
var rpApp = angular.module('rpApp', ['ngRoute', 'ngMaterial', 'ngAnimate', 'ngSanitize', 'ngMessages', 'ngCookies', 'ngResource', 'linkify', 'angularMoment', 'RecursionHelper', 'rt.debounce', 'mediaCheck', 'angular-google-adsense', 'angular-inview', 'youtube-embed', 'rpMedia', 'rpIdentity', 'rpPost', 'rpUser', 'rpMessage', 'rpArticle', 'rpDelete', 'rpCaptcha', 'rpComment', 'rpSettings', 'rpSearch', 'rpShare', 'rpSubmit', 'rpScore', 'rpEdit', 'rpFeedback', 'rpReply', 'rpSave', 'rpHide', 'rpOpenNew', 'rpGild', 'rpLink', 'rpPlus', 'rpSlideshow', 'rpNightTheme', 'rpLoginButton', 'rpSubreddits', 'rpToast', 'rpToolbar', 'rpToolbarSelect', 'rpSubscribe', 'rpError', 'rpSidebar', 'rpSpeedDial', 'rpRefreshButton', 'rpLayoutButton', 'rpDialogCloseButton', 'rpGotoSubreddit', 'rpOverflowMenu', 'rpSocial', 'rpSidenav', 'rpFormatting', 'rpTemplates']);
...
rpApp.config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {

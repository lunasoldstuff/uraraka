...
(function () {
	...
	angular.module('rpPlus').controller('rpPlusSidenavCtrl', ['$scope', '$rootScope', '$mdDialog', 'rpSettingsService', 'rpAppLocationService', 'rpAppIsMobileViewService', 'rpPlusSubscriptionService', rpPlusSidenavCtrl]);

	function rpPlusSidenavCtrl($scope, $rootScope, $mdDialog, rpSettingsService, rpAppLocationService, rpAppIsMobileViewService, rpPlusSubscriptionService) {

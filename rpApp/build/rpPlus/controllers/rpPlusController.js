...
(function () {
	...
	angular.module('rpPlus').controller('rpPlusCtrl', ['$scope', '$rootScope', '$timeout', '$mdDialog', '$mdBottomSheet', 'rpPlusSubscriptionService', 'rpAppAuthService', rpPlusCtrl]);

	function rpPlusCtrl($scope, $rootScope, $timeout, $mdDialog, $mdBottomSheet, rpPlusSubscriptionService, rpAppAuthService) {

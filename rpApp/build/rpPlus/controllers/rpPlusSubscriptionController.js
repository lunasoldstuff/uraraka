...
(function () {
	...
	angular.module('rpPlus').controller('rpPlusSubscriptionCtrl', ['$scope', '$rootScope', 'moment', 'rpPlusSubscriptionService', rpPlusSubscriptionCtrl]);

	function rpPlusSubscriptionCtrl($scope, $rootScope, moment, rpPlusSubscriptionService) {

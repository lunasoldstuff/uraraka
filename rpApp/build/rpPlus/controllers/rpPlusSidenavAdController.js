...
(function () {
	...
	angular.module('rpPlus').controller('rpPlusSidenavAdCtrl', ['$scope', '$mdDialog', 'rpSettingsService', 'rpAppIsMobileViewService', 'rpAppLocationService', rpPlusSidenavAdCtrl]);

	function rpPlusSidenavAdCtrl($scope, $mdDialog, rpSettingsService, rpAppIsMobileViewService, rpAppLocationService) {

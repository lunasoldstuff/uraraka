...
(function () {
	...
	angular.module('rpPlus').factory('rpPlusSubscriptionService', ['$rootScope', '$window', 'rpAppAuthService', 'rpPlusPaypalCreateBillingAgreeement', 'rpPlusPaypalBillingAgreeement', 'rpPlusPaypalCancelBillingAgreeement', 'rpPlusPaypalUpdateBillingAgreeement', 'rpToastService', 'rpSettingsService', rpPlusSubscriptionService]);

	function rpPlusSubscriptionService($rootScope, $window, rpAppAuthService, rpPlusPaypalCreateBillingAgreeement, rpPlusPaypalBillingAgreeement, rpPlusPaypalCancelBillingAgreeement, rpPlusPaypalUpdateBillingAgreeement, rpToastService, rpSettingsService) {

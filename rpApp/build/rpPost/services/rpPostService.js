...
(function () {
	...
	angular.module('rpPost').factory('rpPostService', ['$rootScope', 'rpPostResourceService', 'rpPostFrontpageResourceService', 'rpToastService', 'rpAppLocationService', 'rpAppRedditApiService', rpPostService]);

	function rpPostService($rootScope, rpPostResourceService, rpPostFrontpageResourceService, rpToastService, rpAppLocationService, rpAppRedditApiService) {

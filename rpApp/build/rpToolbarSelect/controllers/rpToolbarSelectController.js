...
(function () {
	...
	angular.module('rpToolbarSelect').controller('rpToolbarSelectCtrl', ['$scope', '$rootScope', '$routeParams', 'rpAppAuthService', 'rpIdentityService', rpToolbarSelectCtrl]);

	function rpToolbarSelectCtrl($scope, $rootScope, $routeParams, rpAppAuthService, rpIdentityService) {

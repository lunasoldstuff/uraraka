...
(function () {
	...
	angular.module('rpSlideshow').controller('rpSlideshowSettingsPanelCtrl', ['$scope', '$rootScope', '$timeout', 'rpSettingsService', rpSlideshowSettingsPanelCtrl]);

	function rpSlideshowSettingsPanelCtrl($scope, $rootScope, $timeout, rpSettingsService) {

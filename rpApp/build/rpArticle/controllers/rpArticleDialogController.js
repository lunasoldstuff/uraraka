...
(function () {
	...
	angular.module('rpArticle').controller('rpArticleDialogCtrl', ['$scope', '$rootScope', '$location', '$filter', '$mdDialog', '$mdBottomSheet', 'rpSettingsService', 'post', 'article', 'comment', 'subreddit', rpArticleDialogCtrl]);

	function rpArticleDialogCtrl($scope, $rootScope, $location, $filter, $mdDialog, $mdBottomSheet, rpSettingsService, post, article, comment, subreddit) {

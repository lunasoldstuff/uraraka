...
(function () {
	...
	angular.module('rpUser').controller('rpUserCtrl', ['$scope', '$rootScope', '$window', '$routeParams', '$timeout', 'rpUserService', 'rpAppTitleChangeService', 'rpSettingsService', 'rpAppLocationService', 'rpIdentityService', 'rpAppAuthService', rpUserCtrl]);

	function rpUserCtrl($scope, $rootScope, $window, $routeParams, $timeout, rpUserService, rpAppTitleChangeService, rpSettingsService, rpAppLocationService, rpIdentityService, rpAppAuthService) {

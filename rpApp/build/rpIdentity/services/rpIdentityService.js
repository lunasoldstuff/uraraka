...
(function () {
	...
	angular.module('rpApp').factory('rpIdentityService', ['rpAppAuthService', 'rpAppRedditApiService', rpIdentityService]);
			...
			if (rpAppAuthService.isAuthenticated) {
				...
				if (rpIdentityService.identity !== null) {
					...
					if (gettingIdentity === false) {
						...
						rpAppRedditApiService.redditRequest('get', '/api/v1/me', {}, function (data) {

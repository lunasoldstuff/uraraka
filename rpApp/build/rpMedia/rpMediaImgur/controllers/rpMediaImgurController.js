...
(function () {
	...
	angular.module('rpMediaImgur').controller('rpMediaImgurCtrl', ['$scope', '$filter', '$mdPanel', rpMediaImgurCtrl]);
	...
	function rpMediaImgurCtrl($scope, $filter, $mdPanel) {
		...
		if (extension == '.gif' || extension == '.gifv' || extension == '.webm') $scope.imgurType = 'video';else $scope.imgurType = 'image';

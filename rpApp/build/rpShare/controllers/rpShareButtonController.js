...
(function () {
	...
	angular.module('rpShare').controller('rpShareButtonCtrl', ['$scope', '$rootScope', '$mdBottomSheet', rpShareButtonCtrl]);

	function rpShareButtonCtrl($scope, $rootScope, $mdBottomSheet) {

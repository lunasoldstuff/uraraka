...
(function () {
	...
	angular.module('rpShare').controller('rpShareEmailFormCtrl', ['$scope', '$timeout', '$mdDialog', '$window', 'rpShareEmailService', 'rpAppLocationService', rpShareEmailFormCtrl]);

	function rpShareEmailFormCtrl($scope, $timeout, $mdDialog, $window, rpShareEmailService, rpAppLocationService) {

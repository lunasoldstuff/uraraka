...
(function () {
	...
	angular.module('rpSpeedDial').controller('rpSpeedDialCtrl', ['$scope', '$rootScope', '$mdDialog', 'rpAppAuthService', 'rpToastService', 'rpSettingsService', 'rpAppLocationService', 'rpAppIsMobileViewService', rpSpeedDialCtrl]);

	function rpSpeedDialCtrl($scope, $rootScope, $mdDialog, rpAppAuthService, rpToastService, rpSettingsService, rpAppLocationService, rpAppIsMobileViewService) {

...
(function () {
	...
	angular.module('rpComment').directive('rpCommentScroll', ['$rootScope', '$timeout', 'debounce', rpCommentScroll]);
		...
		return {
			...
			link: function link(scope, element, attrs) {
				...
				function startWatcinghHeight() {
					stopWatchingHeight = scope.$watch(function () {
						...
						console.log('[rpCommentScroll] height change, newHeight: ' + newHeight + ', oldHeight: ' + oldHeight);

						if (blockFirst) {
							//block the first time this listener fires

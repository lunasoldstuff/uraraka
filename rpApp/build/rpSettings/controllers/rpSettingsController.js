...
(function () {
	...
	angular.module('rpSettings').controller('rpSettingsCtrl', ['$scope', '$rootScope', '$routeParams', 'rpSettingsService', 'rpAppTitleChangeService', 'rpPlusSubscriptionService', rpSettingsCtrl]);

	function rpSettingsCtrl($scope, $rootScope, $routeParams, rpSettingsService, rpAppTitleChangeService, rpPlusSubscriptionService) {

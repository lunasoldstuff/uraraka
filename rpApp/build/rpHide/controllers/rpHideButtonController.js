...
(function () {
	...
	angular.module('rpHide').controller('rpHideButtonCtrl', ['$scope', '$rootScope', 'rpHideService', 'rpAppAuthService', 'rpToastService', rpHideButtonCtrl]);

	function rpHideButtonCtrl($scope, $rootScope, rpHideService, rpAppAuthService, rpToastService) {

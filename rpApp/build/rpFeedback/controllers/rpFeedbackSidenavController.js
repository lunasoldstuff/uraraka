...
(function () {
	...
	angular.module('rpFeedback').controller('rpFeedbackSidenavCtrl', ['$scope', '$mdDialog', 'rpSettingsService', 'rpAppLocationService', 'rpAppAuthService', 'rpToastService', 'rpAppIsMobileViewService', rpFeedbackSidenavCtrl]);

	function rpFeedbackSidenavCtrl($scope, $mdDialog, rpSettingsService, rpAppLocationService, rpAppAuthService, rpToastService, rpAppIsMobileViewService) {

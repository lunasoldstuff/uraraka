...
(function () {
	...
	angular.module('rpFeedback').controller('rpFeedbackFormCtrl', ['$scope', '$timeout', '$mdDialog', '$window', 'rpFeedbackService', 'rpAppLocationService', 'rpIdentityService', rpFeedbackFormCtrl]);

	function rpFeedbackFormCtrl($scope, $timeout, $mdDialog, $window, rpFeedbackService, rpAppLocationService, rpIdentityService) {

...
(function () {
  ...
  angular.module('rpMessage').controller('rpMessageCtrl', ['$scope', '$rootScope', '$routeParams', '$timeout', 'rpMessageService', 'rpIdentityService', 'rpAppTitleChangeService', 'rpMessageReadAllService', 'rpAppLocationService', 'rpSettingsService', 'rpMessageReadService', 'rpToolbarButtonVisibilityService', rpMessageCtrl]);

  function rpMessageCtrl($scope, $rootScope, $routeParams, $timeout, rpMessageService, rpIdentityService, rpAppTitleChangeService, rpMessageReadAllService, rpAppLocationService, rpSettingsService, rpMessageReadService, rpToolbarButtonVisibilityService) {

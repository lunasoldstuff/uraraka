...
(function () {
	...
	angular.module('rpMessage').controller('rpMessageSidenavCtrl', ['$scope', '$rootScope', '$mdDialog', 'rpSettingsService', 'rpAppLocationService', 'rpIdentityService', 'rpAppIsMobileViewService', rpMessageSidenavCtrl]);

	function rpMessageSidenavCtrl($scope, $rootScope, $mdDialog, rpSettingsService, rpAppLocationService, rpIdentityService, rpAppIsMobileViewService) {

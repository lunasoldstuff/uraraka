...
(function () {
	...
	angular.module('rpMessageCompose').controller('rpMessageComposeFormCtrl', ['$scope', '$rootScope', '$timeout', '$mdDialog', '$window', 'rpMessageComposeService', 'rpAppLocationService', rpMessageComposeFormCtrl]);

	function rpMessageComposeFormCtrl($scope, $rootScope, $timeout, $mdDialog, $window, rpMessageComposeService, rpAppLocationService) {

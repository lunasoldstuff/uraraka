...
(function () {
	...
	angular.module('rpMessageCompose').controller('rpMessageComposeCtrl', ['$scope', '$rootScope', '$mdDialog', '$routeParams', 'rpAppLocationService', 'rpSubredditsService', 'rpAppTitleChangeService', rpMessageComposeCtrl]);

	function rpMessageComposeCtrl($scope, $rootScope, $mdDialog, $routeParams, rpAppLocationService, rpSubredditsService, rpAppTitleChangeService) {

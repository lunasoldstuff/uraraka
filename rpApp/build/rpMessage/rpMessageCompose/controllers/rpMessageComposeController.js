...
(function () {
  ...
  angular.module('rpMessageCompose').controller('rpMessageComposeCtrl', ['$scope', '$rootScope', '$mdDialog', '$routeParams', 'rpAppLocationService', 'rpSubredditsService', 'rpAppTitleChangeService', 'rpToolbarButtonVisibilityService', rpMessageComposeCtrl]);

  function rpMessageComposeCtrl($scope, $rootScope, $mdDialog, $routeParams, rpAppLocationService, rpSubredditsService, rpAppTitleChangeService, rpToolbarButtonVisibilityService) {
    ...
    $scope.title = angular.isDefined($scope.shareLink) && $scope.shareLink !== null ? 'share a link with a reddit user' : 'send a message';

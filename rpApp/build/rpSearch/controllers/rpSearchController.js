...
(function () {
	...
	angular.module('rpSearch').controller('rpSearchCtrl', ['$scope', '$rootScope', '$routeParams', '$location', '$window', '$timeout', '$mdDialog', '$mdBottomSheet', 'rpSubredditsService', 'rpSearchService', 'rpSearchFormService', 'rpAppLocationService', 'rpSettingsService', 'rpAppTitleChangeService', 'rpAppAuthService', 'rpIdentityService', rpSearchCtrl]);

	function rpSearchCtrl($scope, $rootScope, $routeParams, $location, $window, $timeout, $mdDialog, $mdBottomSheet, rpSubredditsService, rpSearchService, rpSearchFormService, rpAppLocationService, rpSettingsService, rpAppTitleChangeService, rpAppAuthService, rpIdentityService) {

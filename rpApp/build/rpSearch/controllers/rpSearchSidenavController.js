...
(function () {
	...
	angular.module('rpSearch').controller('rpSearchSidenavCtrl', ['$scope', '$rootScope', 'rpSearchFormService', rpSearchSidenavCtrl]);

	function rpSearchSidenavCtrl($scope, $rootScope, rpSearchFormService) {

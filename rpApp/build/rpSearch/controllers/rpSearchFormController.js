...
(function () {
	...
	angular.module('rpSearch').controller('rpSearchFormCtrl', ['$scope', '$rootScope', '$location', '$routeParams', '$timeout', 'rpSearchService', 'rpSubredditsService', 'rpAppLocationService', rpSearchFormCtrl]);

	function rpSearchFormCtrl($scope, $rootScope, $location, $routeParams, $timeout, rpSearchService, rpSubredditsService, rpAppLocationService) {
		...
		$scope.submitSearchForm = function (e) {
			...
			if ($scope.params.sub === '') {
				...
				if (rpSubredditsService.currentSub && rpSubredditsService.currentSub !== '') $scope.params.sub = rpSubredditsService.currentSub;else $scope.params.sub = "all";
			}
			...
			$timeout(function () {
				rpAppLocationService(null, '/search', 'q=' + $scope.params.q + '&sub=' + $scope.params.sub + '&type=' + $scope.params.type + '&restrict_sr=' + $scope.params.restrict_sr + '&sort=' + $scope.params.sort + '&after=' + $scope.params.after + '&t=' + $scope.params.t, !onSearchPage, false);

(function () {
  ...
  function rpSlideshowPlayButton($rootScope) {
    return {
      ...
      link: function (scope, element, attrs) {
        var deregisterPlayStateChanged;
        ...
        function setIconState() {
          ...
          if (scope.isPlaying) {
            ...
            document.getElementById('reverseAnimation-bar1')
              .beginElement();
            document.getElementById('reverseAnimation-bar2')
              .beginElement();
          } else {
            console.log('[rpSlideshowPlayButton] link(), setIconState(), startAnimation');
            document.getElementById('startAnimation-bar1')
              .beginElement();
            document.getElementById('startAnimation-bar2')
              .beginElement();
          }
        }
        ...
        deregisterPlayStateChanged = $rootScope.$on('rp_slideshow_play_state_changed', function (e, isPlaying) {
          setIconState();
        });
        ...
        if (scope.isPlaying) {
          console.log('[rpSlideshowPlayButton] link(), setIconState(), reverseAnimation');
          document.getElementById('reverseAnimationInstant-bar1')
            .beginElement();
          document.getElementById('reverseAnimationInstant-bar2')
            .beginElement();
        } else {
          console.log('[rpSlideshowPlayButton] link(), setIconState(), startAnimation');
          document.getElementById('startAnimationInstant-bar1')
            .beginElement();
          document.getElementById('startAnimationInstant-bar2')
            .beginElement();
        }
  ...
  angular.module('rpSlideshow')
    .directive('rpSlideshowPlayButton', [
      '$rootScope',
